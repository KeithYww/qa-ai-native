...
class IncidentCreationAgent(AgentBase):
    ...
    def __init__(self):
        ...
        model_name = get_model(
            config.IncidentCreationAgentConfig.MODEL_NAME, config.IncidentCreationAgentConfig.FALLBACK_MODEL_NAME
        )
        ...
        super().__init__(
            ...
            fallback_model_name=config.IncidentCreationAgentConfig.FALLBACK_MODEL_NAME,
    ...
    def get_skills(self) -> list[AgentSkill]:
        return [
            AgentSkill(
                ...
                description="Creates detailed incident reports in Jira based on test execution results.",
                tags=["qa", "incident-creation"],
            )
        ]
