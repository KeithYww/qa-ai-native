...
class TestCaseReviewSystemPrompt(PromptBase):
    ...
    def __init__(
        self,
        attachments_remote_folder_path: str,
        batch_size: int,
        ...
        Args:
            ...
            batch_size: Maximum number of test cases to submit per review tool call.
    ...
    def get_prompt(self) -> str:
        ...
        return self.template.format(
            attachments_remote_folder_path=self.attachments_remote_folder_path, batch_size=self.batch_size
        )
