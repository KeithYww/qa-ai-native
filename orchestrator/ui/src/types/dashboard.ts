...
// Debug trace: pydantic-ai's redacted message history (see common/trace_redaction.py).
// The shape is dictated by pydantic-ai's own serialization, so it is kept loose here
// rather than exhaustively typed.
