...
import { ClipboardList, CheckCircle, XCircle, Clock, Loader2, GitBranch } from 'lucide-react';
    ...
    <>
      ...
      {traceTask && (
        <TraceViewer
          ...
          taskId={traceTask}
          isRunning={tasks?.find((t) => t.task_id === traceTask)?.status === 'RUNNING'}
        />
      )}
    </>
  );
